    ...
    <div class="container">
        <div class="arriv-top">
            <div class="col-md-6 arriv-left">
                <img src="<?=$config->theme->url;?>/images/1.jpg" class="img-responsive" alt="">
            ...
            <div class="col-md-6 arriv-right">
                <img src="<?=$config->theme->url;?>/images/2.jpg" class="img-responsive" alt="">
                <div class="arriv-info">
                    <h3>TUXEDO</h3>
                    <p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
                    <div class="crt-btn">
        ...
        <div class="arriv-bottm">
            <div class="col-md-8 arriv-left1">
                <img src="<?=$config->theme->url;?>/images/3.jpg" class="img-responsive" alt="">
        ...
        <div class="arriv-las">
            ...
            <div class="col-md-4 arriv-middle">
                <img src="<?=$config->theme->url;?>/images/6.jpg" class="img-responsive" alt="">
